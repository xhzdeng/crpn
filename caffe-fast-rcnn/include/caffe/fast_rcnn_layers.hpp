...
template <typename Dtype>
class RotateROIPoolingLayer : public Layer<Dtype> {
 public:
  explicit RotateROIPoolingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "RotateROIPooling"; }
...
class RotateROIAlignLayer : public Layer<Dtype> {
 public:
  ...
  virtual inline const char* type() const { return "RotateROIAlign"; }
